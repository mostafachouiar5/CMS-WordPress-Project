...
class Wpe_Content_Engine {
	...
	public function register_blocks() {
		$facets = new WPE_Atlas_Search_Facets_Callbacks( $this->loader );
		$facets->init();
	}
	...
	private function load_dependencies() {
		...
		*/
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'src/index/batch.php';
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'src/query/meta.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'src/query/taxonomy.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'src/blocks/blocks-callbacks.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'src/support/woocommerce/filters.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'src/support/woocommerce/fields.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'src/support/woocommerce/queries.php';
	}
